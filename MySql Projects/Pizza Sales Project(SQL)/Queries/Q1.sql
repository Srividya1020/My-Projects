...
/*CREATE TABLE pizza_types (
	...
	orders PRIMARY KEY (pizza_type_id)
);*/
...
('ital_supr', 'The Italian Supreme Pizza', 'Supreme', 'Genoa Salami, Capocollo, Pepperoni, Tomatoes, Asiago Cheese, Garlic'),
('pep_salami', 'The Pepper Salami Pizza', 'Supreme', 'Genoa Salami, Capocollo, Pepperoni, Tomatoes, Asiago Cheese, Garlic'),
